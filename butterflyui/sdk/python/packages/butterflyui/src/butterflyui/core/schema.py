...
GALLERY_SCHEMA = _control_schema(
    {
        ...
        "selectable": BOOL_SCHEMA,
        "enabled": BOOL_SCHEMA,
        "gallery_toolbar": {"type": "object", "additionalProperties": True},
        "gallery_filter_bar": {"type": "object", "additionalProperties": True},
        "gallery_grid_layout": {"type": "object", "additionalProperties": True},
        "gallery_item_actions": {"type": "object", "additionalProperties": True},
        "gallery_item_badge": {"type": "object", "additionalProperties": True},
        "gallery_item_meta_row": {"type": "object", "additionalProperties": True},
        "gallery_item_preview": {"type": "object", "additionalProperties": True},
        "gallery_item_selectable": {"type": "object", "additionalProperties": True},
        "gallery_item_tile": {"type": "object", "additionalProperties": True},
        "gallery_pagination": {"type": "object", "additionalProperties": True},
        "gallery_section_header": {"type": "object", "additionalProperties": True},
        "gallery_sort_bar": {"type": "object", "additionalProperties": True},
        "gallery_empty_state": {"type": "object", "additionalProperties": True},
        "gallery_loading_skeleton": {"type": "object", "additionalProperties": True},
        "gallery_search_bar": {"type": "object", "additionalProperties": True},
        "gallery_font_picker": {"type": "object", "additionalProperties": True},
        "gallery_audio_picker": {"type": "object", "additionalProperties": True},
        "gallery_video_picker": {"type": "object", "additionalProperties": True},
        "gallery_image_picker": {"type": "object", "additionalProperties": True},
        "gallery_item_drag_handle": {"type": "object", "additionalProperties": True},
        "gallery_item_drop_target": {"type": "object", "additionalProperties": True},
        "gallery_item_reorder_handle": {"type": "object", "additionalProperties": True},
        "gallery_item_selection_checkbox": {"type": "object", "additionalProperties": True},
        "gallery_item_selection_radio": {"type": "object", "additionalProperties": True},
        "gallery_item_selection_switch": {"type": "object", "additionalProperties": True},
        "gallery_action": {"type": "object", "additionalProperties": True},
        "gallery_apply": {"type": "object", "additionalProperties": True},
        "gallery_clear": {"type": "object", "additionalProperties": True},
        "gallery_select_all": {"type": "object", "additionalProperties": True},
        "gallery_deselect_all": {"type": "object", "additionalProperties": True},
        "gallery_apply_font": {"type": "object", "additionalProperties": True},
        "gallery_apply_image": {"type": "object", "additionalProperties": True},
        "gallery_set_as_wallpaper": {"type": "object", "additionalProperties": True},
    }
)
...
SKINS_SCHEMA = _control_schema(
    {
        ...
        "value": STRING_SCHEMA,
        "enabled": BOOL_SCHEMA,
        "skins_selector": {"type": "object", "additionalProperties": True},
        "skins_preset": {"type": "object", "additionalProperties": True},
        "skins_editor": {"type": "object", "additionalProperties": True},
        "skins_preview": {"type": "object", "additionalProperties": True},
        "skins_apply": {"type": "object", "additionalProperties": True},
        "skins_clear": {"type": "object", "additionalProperties": True},
        "skins_token_mapper": {"type": "object", "additionalProperties": True},
        "create_skin": {"type": "object", "additionalProperties": True},
        "edit_skin": {"type": "object", "additionalProperties": True},
        "delete_skin": {"type": "object", "additionalProperties": True},
    }
)
...
GRADIENT_SWEEP_SCHEMA = _control_schema(
    {
        "colors": {"type": "array", "items": STRING_SCHEMA},
        "duration_ms": INTEGER_SCHEMA,
        "angle": NUMBER_SCHEMA,
        "opacity": NUMBER_SCHEMA,
    }
...
BREADCRUMB_BAR_SCHEMA = CRUMB_TRAIL_SCHEMA
...
CONTROL_SCHEMAS = {
    ...
    "bar_chart": _control_schema({"series": {"type": "array", "items": {"type": "object"}}, "data": ANY_SCHEMA, "kind": STRING_SCHEMA}),
    ...
    "border": _control_schema({"color": COLOR_SCHEMA, "width": NUMBER_SCHEMA, "radius": NUMBER_SCHEMA}),
    "border_side": _control_schema({"side": STRING_SCHEMA, "color": COLOR_SCHEMA, "width": NUMBER_SCHEMA}),
    "button_style": _control_schema({"value": STRING_SCHEMA, "options": {"type": "array", "items": ANY_SCHEMA}}),
    ...
    "date_picker": _control_schema({"value": ANY_SCHEMA, "enabled": BOOL_SCHEMA}),
    ...
    "date_range_picker": _control_schema({"value": ANY_SCHEMA, "start": ANY_SCHEMA, "end": ANY_SCHEMA, "enabled": BOOL_SCHEMA}),
    "date_range": _control_schema({"value": ANY_SCHEMA, "start": ANY_SCHEMA, "end": ANY_SCHEMA, "enabled": BOOL_SCHEMA}),
    ...
    "file_system": VIRTUAL_FILE_SYSTEM_SCHEMA,
    ...
    "filter_drawer": _control_schema({"title": STRING_SCHEMA, "open": BOOL_SCHEMA, "schema": {"type": "object"}, "state": {"type": "object"}, "show_actions": BOOL_SCHEMA, "apply_label": STRING_SCHEMA, "clear_label": STRING_SCHEMA, "dense": BOOL_SCHEMA}),
    ...
    "hover_region": _control_schema({"enabled": BOOL_SCHEMA, "opaque": BOOL_SCHEMA, "cursor": STRING_SCHEMA}),
...
RUNTIME_PROP_HINTS = {
    ...
    'gallery': [
        'items', 'spacing', 'run_spacing', 'tile_width', 'tile_height', 'selectable', 'enabled', 'events',
        'gallery_toolbar', 'gallery_filter_bar', 'gallery_grid_layout', 'gallery_item_actions', 'gallery_item_badge',
        'gallery_item_meta_row', 'gallery_item_preview', 'gallery_item_selectable', 'gallery_item_tile',
        'gallery_pagination', 'gallery_section_header', 'gallery_sort_bar', 'gallery_empty_state',
        'gallery_loading_skeleton', 'gallery_search_bar', 'gallery_font_picker', 'gallery_audio_picker',
        'gallery_video_picker', 'gallery_image_picker', 'gallery_item_drag_handle', 'gallery_item_drop_target',
        'gallery_item_reorder_handle', 'gallery_item_selection_checkbox', 'gallery_item_selection_radio',
        'gallery_item_selection_switch', 'gallery_action', 'gallery_apply', 'gallery_clear', 'gallery_select_all',
        'gallery_deselect_all', 'gallery_apply_font', 'gallery_apply_image', 'gallery_set_as_wallpaper',
        'state', 'payload'
    ],
    'skins': [
        'skins', 'selected_skin', 'presets', 'value', 'enabled', 'events',
        'skins_selector', 'skins_preset', 'skins_editor', 'skins_preview', 'skins_apply', 'skins_clear',
        'skins_token_mapper', 'create_skin', 'edit_skin', 'delete_skin', 'state', 'payload'
    ],
