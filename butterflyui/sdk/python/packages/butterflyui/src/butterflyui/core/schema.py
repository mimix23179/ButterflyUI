...
UNIVERSAL_PROPS_SCHEMA = {
    ...
    # Universal color contract used across layout/overlay/display controls.
    "color": COLOR_SCHEMA,
    "foreground": COLOR_SCHEMA,
    "text_color": COLOR_SCHEMA,
    "icon_color": COLOR_SCHEMA,
    "icon_background": COLOR_SCHEMA,
    "icon_foreground": COLOR_SCHEMA,
    "icon_opacity": NUMBER_SCHEMA,
    "background": COLOR_SCHEMA,
    "bgcolor": COLOR_SCHEMA,
    "surface_color": COLOR_SCHEMA,
    "border_color": COLOR_SCHEMA,
    "scrim_color": COLOR_SCHEMA,
    "transparency": NUMBER_SCHEMA,
    "alpha": NUMBER_SCHEMA,
    "icon": ANY_SCHEMA,
    "leading_icon": ANY_SCHEMA,
    "trailing_icon": ANY_SCHEMA,
    "icon_position": STRING_SCHEMA,
    "icon_size": NUMBER_SCHEMA,
    "icon_spacing": NUMBER_SCHEMA,
    "decorate_icon": BOOL_SCHEMA,
    "auto_contrast": BOOL_SCHEMA,
    "min_contrast": NUMBER_SCHEMA,
...
def _typed_schema_overrides() -> dict[str, dict[str, Any]]:
    return {
        ...
        "artifact_card": _control_schema({
            ...
            "title_color": COLOR_SCHEMA,
            "message_color": COLOR_SCHEMA,
            "action_variant": STRING_SCHEMA,
            "action_color": COLOR_SCHEMA,
            "action_text_color": COLOR_SCHEMA,
            "action_radius": NUMBER_SCHEMA,
            "bgcolor": COLOR_SCHEMA,
            "background": COLOR_SCHEMA,
            "gradient": ANY_SCHEMA,
            "border_color": COLOR_SCHEMA,
            ...
            "backdrop_color": COLOR_SCHEMA,
            "backdrop_blur": NUMBER_SCHEMA,
            "blur": NUMBER_SCHEMA,
            "glow": BOOL_SCHEMA,
            "shadow": ANY_SCHEMA,
            "events": {"type": "array", "items": STRING_SCHEMA},
        }),
        "button": _control_schema({
            "label": STRING_SCHEMA,
            "text": STRING_SCHEMA,
            "value": ANY_SCHEMA,
            "variant": STRING_SCHEMA,
            ...
            "text_color": COLOR_SCHEMA,
            "transparency": NUMBER_SCHEMA,
            "button_surface": BOOL_SCHEMA,
            "decorated": BOOL_SCHEMA,
            "glass": BOOL_SCHEMA,
            "surface": BOOL_SCHEMA,
            "gradient": ANY_SCHEMA,
            "shadow": ANY_SCHEMA,
        ...
        "elevated_button": _control_schema({
            "label": STRING_SCHEMA,
            "text": STRING_SCHEMA,
            "value": ANY_SCHEMA,
            "icon": ANY_SCHEMA,
        ...
        "outlined_button": _control_schema({
            "label": STRING_SCHEMA,
            "text": STRING_SCHEMA,
            "value": ANY_SCHEMA,
            "icon": ANY_SCHEMA,
        ...
        "candy_scope": _control_schema({
            ...
            "ambient": {"type": "array", "items": STRING_SCHEMA},
            "reactive": {"type": "array", "items": STRING_SCHEMA},
            "decor": {"type": "array", "items": STRING_SCHEMA},
            "scene": {"type": "object", "additionalProperties": ANY_SCHEMA},
            "scene_layers": {"type": "array", "items": ANY_SCHEMA},
            "background_layers": {"type": "array", "items": ANY_SCHEMA},
            "overlay_layers": {"type": "array", "items": ANY_SCHEMA},
            "actor": {"type": "object", "additionalProperties": ANY_SCHEMA},
            "actors": {"type": "array", "items": ANY_SCHEMA},
        ...
        "progress_bar": _control_schema({
            ...
            "label": STRING_SCHEMA,
            "helper": STRING_SCHEMA,
            "helper_text": STRING_SCHEMA,
            "stroke_width": NUMBER_SCHEMA,
            "variant": STRING_SCHEMA,
            "show_value": BOOL_SCHEMA,
            "value_template": STRING_SCHEMA,
            "track_height": NUMBER_SCHEMA,
            "bar_height": NUMBER_SCHEMA,
            "segments": INTEGER_SCHEMA,
            "segment_gap": NUMBER_SCHEMA,
            "glow": BOOL_SCHEMA,
            "glow_color": COLOR_SCHEMA,
            "gradient": ANY_SCHEMA,
            "progress_color": COLOR_SCHEMA,
            "accent_color": COLOR_SCHEMA,
            "secondary_color": COLOR_SCHEMA,
            "gradient_end": COLOR_SCHEMA,
            "background_color": COLOR_SCHEMA,
            "track_color": COLOR_SCHEMA,
            "surface_color": COLOR_SCHEMA,
            "animation_duration_ms": INTEGER_SCHEMA,
        ...
        "skins_scope": _control_schema({
            ...
            "tokens": {"type": "object", "additionalProperties": ANY_SCHEMA},
            "brightness": STRING_SCHEMA,
            "linked_candy": {"type": "array", "items": STRING_SCHEMA},
            "auto_palette": BOOL_SCHEMA,
            "palette_source": ANY_SCHEMA,
            "palette_strength": NUMBER_SCHEMA,
            "child": ANY_SCHEMA,
            "children": {"type": "array", "items": ANY_SCHEMA},
        }),
        "gallery_scope": _control_schema({
            "collection_name": STRING_SCHEMA,
            "collection_subtitle": STRING_SCHEMA,
            "showcase": BOOL_SCHEMA,
            "preview_mode": STRING_SCHEMA,
            "group_by": STRING_SCHEMA,
            "filter_tags": {"type": "array", "items": STRING_SCHEMA},
            "empty_title": STRING_SCHEMA,
            "empty_message": STRING_SCHEMA,
            "palette_source": ANY_SCHEMA,
            "palette_accents": BOOL_SCHEMA,
            "palette_strength": NUMBER_SCHEMA,
            "child": ANY_SCHEMA,
            "children": {"type": "array", "items": ANY_SCHEMA},
        }),
        "gallery": _control_schema({
            "items": {"type": "array", "items": ANY_SCHEMA},
            "module": STRING_SCHEMA,
            "layout": STRING_SCHEMA,
            "type_filter": STRING_SCHEMA,
            "collection_name": STRING_SCHEMA,
            "collection_subtitle": STRING_SCHEMA,
            "showcase": BOOL_SCHEMA,
            "preview_mode": STRING_SCHEMA,
            ...
            "palette_accents": BOOL_SCHEMA,
            "palette_strength": NUMBER_SCHEMA,
            "lazy_preview": BOOL_SCHEMA,
            "autoplay_visible_media": BOOL_SCHEMA,
            "preview_visibility_threshold": NUMBER_SCHEMA,
            "columns": INTEGER_SCHEMA,
            "spacing": NUMBER_SCHEMA,
            "main_axis_spacing": NUMBER_SCHEMA,
            "cross_axis_spacing": NUMBER_SCHEMA,
            "carousel_height": NUMBER_SCHEMA,
            "carousel_aspect_ratio": NUMBER_SCHEMA,
            "carousel_viewport_fraction": NUMBER_SCHEMA,
            "carousel_pad_ends": BOOL_SCHEMA,
            "carousel_page_snapping": BOOL_SCHEMA,
            "carousel_initial_page": INTEGER_SCHEMA,
            "carousel_overlay_opacity": NUMBER_SCHEMA,
            "carousel_horizontal_inset": NUMBER_SCHEMA,
            "carousel_vertical_inset": NUMBER_SCHEMA,
            "events": {"type": "array", "items": STRING_SCHEMA},
        }),
