...
GALLERY_SCHEMA = _control_schema(
    {
        "images": {"type": "array", "items": STRING_SCHEMA},
        "columns": INTEGER_SCHEMA,
        "spacing": NUMBER_SCHEMA,
        "radius": NUMBER_SCHEMA,
        "fit": STRING_SCHEMA,
        "allow_zoom": BOOL_SCHEMA,
    }
)
...
CONTROL_SCHEMAS = {
    ...
    "candy_gallery": _control_schema({"items": {"type": "array", "items": ANY_SCHEMA}, "spacing": NUMBER_SCHEMA}),
    ...
    "stack": STACK_SCHEMA,
    "box": SURFACE_SCHEMA,
    "page": _control_schema({"safe_area": BOOL_SCHEMA, "bgcolor": COLOR_SCHEMA, "background": COLOR_SCHEMA}),
    "ux_root": UX_ROOT_SCHEMA,
    "wrap": WRAP_SCHEMA,
    "grid": GRID_SCHEMA,
    "list_view": LIST_SURFACE_SCHEMA,
    "virtual_grid": GRID_VIEW_SCHEMA,
    "data_table": GRID_VIEW_SCHEMA,
    "file_browser": FILE_TREE_SCHEMA,
    "task_list": LIST_SURFACE_SCHEMA,
    ...
    "pose": POSE_SCHEMA,
    "layer": LAYER_SCHEMA,
    "layer_list": LAYER_LIST_SCHEMA,
    "bounds_probe": BOUNDS_PROBE_SCHEMA,
    "pan_zoom": PAN_ZOOM_SCHEMA,
    "snap_grid": SNAP_GRID_SCHEMA,
    "motion": MOTION_SCHEMA,
    "timeline": TIMELINE_SCHEMA,
    "stagger": STAGGER_SCHEMA,
    "gesture_area": GESTURE_AREA_SCHEMA,
    "drag_payload": DRAG_PAYLOAD_SCHEMA,
    "drop_zone": DROP_ZONE_SCHEMA,
    "list_surface": LIST_SURFACE_SCHEMA,
    "sticky_list": STICKY_LIST_SCHEMA,
    "grid_view": GRID_VIEW_SCHEMA,
    "effect_layer": EFFECT_LAYER_SCHEMA,
    "canvas": CANVAS_SCHEMA,
    "vector_view": VECTOR_VIEW_SCHEMA,
    "gradient": GRADIENT_SCHEMA,
    "particle_field": PARTICLE_FIELD_SCHEMA,
    "progress_timeline": _control_schema({"steps": {"type": "array", "items": {"type": "object"}}, "current_step": INTEGER_SCHEMA, "dense": BOOL_SCHEMA}),
    "form_field": _control_schema({"label": STRING_SCHEMA, "description": STRING_SCHEMA, "required": BOOL_SCHEMA, "helper_text": STRING_SCHEMA, "error_text": STRING_SCHEMA}),
    "validation_summary": _control_schema({"title": STRING_SCHEMA, "errors": {"type": "array", "items": STRING_SCHEMA}}),
    "audio": AUDIO_SCHEMA,
    "video": VIDEO_SCHEMA,
...
_ALL_CONTROL_TYPES = {
    ...
    "gallery_item_badge",
    "gallery_item_meta_row",
    "gallery_item_preview",
    "gallery_item_selectable",
    "gallery_loading_skeleton",
    "gallery_empty_state",
    "gallery_pagination",
...
RUNTIME_PROP_HINTS = {
    ...
    'code_block': ['text'],
    'color_swatch_grid': ['items', 'selected'],
    ...
    'gallery_toolbar': ['title', 'subtitle', 'actions', 'items'],
    'gallery_search_bar': ['query', 'value', 'placeholder', 'debounce_ms', 'enabled', 'show_clear', 'dense', 'autofocus', 'tokens'],
    'gallery_filter_bar': ['filters', 'mode', 'field', 'multi_select', 'values', 'indices', 'enabled', 'dense', 'spacing'],
    'gallery_sort_bar': ['options', 'items', 'selected', 'selected_index', 'value', 'mode', 'label', 'dense'],
    'gallery_grid_layout': ['columns', 'spacing', 'radius', 'tile_size', 'density', 'layout'],
    'gallery_item_tile': ['id', 'title', 'subtitle', 'badge', 'status', 'status_color', 'meta', 'tags', 'kind', 'src', 'icon', 'selectable', 'selected', 'group', 'actions', 'preview', 'overlay', 'content', 'enabled', 'dense'],
    'gallery_item_actions': ['actions', 'items', 'mode', 'compact'],
    'gallery_item_badge': ['text', 'label', 'color'],
    'gallery_item_meta_row': ['items', 'meta'],
    'gallery_item_preview': ['content'],
    'gallery_item_selectable': ['selected', 'selectable', 'mode'],
    'gallery_loading_skeleton': ['count', 'columns', 'spacing', 'radius', 'tile_size'],
    'gallery_empty_state': ['title', 'message', 'action_label', 'icon'],
    'gallery_pagination': ['page', 'pages', 'page_count', 'page_size', 'total', 'enabled', 'prev_label', 'next_label', 'one_based'],
    'gallery_section_header': ['id', 'title', 'subtitle', 'count', 'actions', 'items'],
