...
MODULE_TOKEN = "search_provider"


class SearchProvider(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_provider`."""

    control_type = "code_editor_search_provider"
