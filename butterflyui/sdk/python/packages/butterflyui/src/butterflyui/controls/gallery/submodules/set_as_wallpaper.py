...
MODULE_TOKEN = "set_as_wallpaper"


class SetAsWallpaper(GallerySubmodule):
    """Gallery submodule host control for `set_as_wallpaper`."""

    control_type = "gallery_set_as_wallpaper"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if selected_image is not None:
            resolved_payload["selected_image"] = selected_image
