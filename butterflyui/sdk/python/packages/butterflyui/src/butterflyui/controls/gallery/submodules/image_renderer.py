...
MODULE_TOKEN = "image_renderer"


class ImageRenderer(GallerySubmodule):
    """Gallery submodule host control for `image_renderer`."""

    control_type = "gallery_image_renderer"
    umbrella = "gallery"
