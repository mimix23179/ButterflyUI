...
MODULE_TOKEN = "ghost_editor"


class GhostEditor(CodeEditorSubmodule):
    """CodeEditor submodule host control for `ghost_editor`."""

    control_type = "code_editor_ghost_editor"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if completions is not None:
            resolved_payload["completions"] = completions
        ...
        if ghost_text is not None:
            resolved_payload["ghost_text"] = ghost_text
