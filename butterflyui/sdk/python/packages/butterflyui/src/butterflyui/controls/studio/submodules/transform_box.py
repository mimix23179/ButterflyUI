...
MODULE_TOKEN = 'transform_box'


class TransformBox(StudioSubmodule):
    """Studio submodule host control for `transform_box`."""

    control_type = 'studio_transform_box'
    umbrella = 'studio'
