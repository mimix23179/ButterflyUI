...
MODULE_TOKEN = "editor_surface"


class EditorSurface(CodeEditorSubmodule):
    """CodeEditor submodule host control for `editor_surface`."""

    control_type = "code_editor_editor_surface"
