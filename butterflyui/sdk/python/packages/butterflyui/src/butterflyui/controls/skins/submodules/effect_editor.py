...
MODULE_TOKEN = 'effect_editor'


class EffectEditor(SkinsSubmodule):
    """Skins submodule host control for `effect_editor`."""

    control_type = 'skins_effect_editor'
    umbrella = 'skins'
