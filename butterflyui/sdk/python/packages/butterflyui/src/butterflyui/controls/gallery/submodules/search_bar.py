...
MODULE_TOKEN = "search_bar"


class SearchBar(GallerySubmodule):
    """Gallery submodule host control for `search_bar`."""

    control_type = "gallery_search_bar"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if search_scope is not None:
            resolved_payload["search_scope"] = search_scope
