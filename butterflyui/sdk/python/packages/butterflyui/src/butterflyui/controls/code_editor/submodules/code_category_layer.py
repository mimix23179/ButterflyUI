...
MODULE_TOKEN = "code_category_layer"


class CodeCategoryLayer(CodeEditorSubmodule):
    """CodeEditor submodule host control for `code_category_layer`."""

    control_type = "code_editor_code_category_layer"
