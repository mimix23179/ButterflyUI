...
MODULE_TOKEN = 'shader_editor'


class ShaderEditor(SkinsSubmodule):
    """Skins submodule host control for `shader_editor`."""

    control_type = 'skins_shader_editor'
    umbrella = 'skins'
