...
MODULE_TOKEN = 'component_palette'


class ComponentPalette(StudioSubmodule):
    """Studio submodule host control for `component_palette`."""

    control_type = 'studio_component_palette'
    umbrella = 'studio'
