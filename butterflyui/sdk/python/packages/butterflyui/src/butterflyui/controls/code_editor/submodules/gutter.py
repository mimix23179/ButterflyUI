...
class Gutter(CodeEditorSubmodule):
    """CodeEditor submodule host control for `gutter`."""

    control_type = "code_editor_gutter"
    ...
    def __init__(
        ...
        strict: bool = False,
        breakpoints: list[object] | None = None,
        code: str | None = None,
        ...
        line_decorations: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if line_decorations is not None:
            resolved_payload["line_decorations"] = line_decorations
