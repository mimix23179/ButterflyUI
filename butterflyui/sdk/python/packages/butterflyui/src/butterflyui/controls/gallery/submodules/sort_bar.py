...
MODULE_TOKEN = "sort_bar"


class SortBar(GallerySubmodule):
    """Gallery submodule host control for `sort_bar`."""

    control_type = "gallery_sort_bar"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        *children: object,
        ...
        sort_options: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if sort_options is not None:
            resolved_payload["sort_options"] = sort_options
