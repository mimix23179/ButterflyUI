...
MODULE_TOKEN = "audio_picker"


class AudioPicker(GallerySubmodule):
    """Gallery submodule host control for `audio_picker`."""

    control_type = "gallery_audio_picker"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if selected_audio is not None:
            resolved_payload["selected_audio"] = selected_audio
