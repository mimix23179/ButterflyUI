...
MODULE_TOKEN = 'progress_view'


class ProgressView(TerminalSubmodule):
    """Terminal submodule host control for `progress_view`."""

    control_type = 'terminal_progress_view'
    umbrella = 'terminal'
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if indeterminate is not None:
            resolved_payload['indeterminate'] = indeterminate
        ...
        if percent is not None:
            resolved_payload['percent'] = percent
        if progress is not None:
            resolved_payload['progress'] = progress
