...
MODULE_TOKEN = "diff_narrator"


class DiffNarrator(CodeEditorSubmodule):
    """CodeEditor submodule host control for `diff_narrator`."""

    control_type = "code_editor_diff_narrator"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if chunks is not None:
            resolved_payload["chunks"] = chunks
        if code is not None:
