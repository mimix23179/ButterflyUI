...
MODULE_TOKEN = "explorer_tree"


class ExplorerTree(CodeEditorSubmodule):
    """CodeEditor submodule host control for `explorer_tree`."""

    control_type = "code_editor_explorer_tree"
