...
MODULE_TOKEN = "document"


class Document(GallerySubmodule):
    """Gallery submodule host control for `document`."""

    control_type = "gallery_document"
    umbrella = "gallery"
