...
MODULE_TOKEN = 'properties_panel'


class PropertiesPanel(StudioSubmodule):
    """Studio submodule host control for `properties_panel`."""

    control_type = 'studio_properties_panel'
    umbrella = 'studio'
