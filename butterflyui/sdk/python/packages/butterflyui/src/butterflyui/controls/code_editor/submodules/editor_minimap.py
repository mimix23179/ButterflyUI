...
MODULE_TOKEN = "editor_minimap"


class EditorMinimap(CodeEditorSubmodule):
    """CodeEditor submodule host control for `editor_minimap`."""

    control_type = "code_editor_editor_minimap"
