...
MODULE_TOKEN = "inline_search_overlay"


class InlineSearchOverlay(CodeEditorSubmodule):
    """CodeEditor submodule host control for `inline_search_overlay`."""

    control_type = "code_editor_inline_search_overlay"
