...
MODULE_TOKEN = "item_selection_radio"


class ItemSelectionRadio(GallerySubmodule):
    """Gallery submodule host control for `item_selection_radio`."""

    control_type = "gallery_item_selection_radio"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if choice is not None:
            resolved_payload["choice"] = choice
