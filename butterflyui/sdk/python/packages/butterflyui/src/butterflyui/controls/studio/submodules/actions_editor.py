...
MODULE_TOKEN = 'actions_editor'


class ActionsEditor(StudioSubmodule):
    """Studio submodule host control for `actions_editor`."""

    control_type = 'studio_actions_editor'
    umbrella = 'studio'
