...
MODULE_TOKEN = 'particles'


class Particles(SkinsSubmodule):
    """Skins submodule host control for `particles`."""

    control_type = 'skins_particles'
    umbrella = 'skins'
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if distribution is not None:
            resolved_payload['distribution'] = distribution
        if distributions is not None:
            resolved_payload['distributions'] = distributions
        if editor is not None:
            resolved_payload['editor'] = editor
        ...
        if pipeline is not None:
            resolved_payload['pipeline'] = pipeline
        if pipelines is not None:
            resolved_payload['pipelines'] = pipelines
        if presets is not None:
            resolved_payload['presets'] = presets
        if preview is not None:
            resolved_payload['preview'] = preview
