...
MODULE_TOKEN = "scoped_search_replace"


class ScopedSearchReplace(CodeEditorSubmodule):
    """CodeEditor submodule host control for `scoped_search_replace`."""

    control_type = "code_editor_scoped_search_replace"
