...
MODULE_TOKEN = "diagnostics_panel"


class DiagnosticsPanel(CodeEditorSubmodule):
    """CodeEditor submodule host control for `diagnostics_panel`."""

    control_type = "code_editor_diagnostics_panel"
