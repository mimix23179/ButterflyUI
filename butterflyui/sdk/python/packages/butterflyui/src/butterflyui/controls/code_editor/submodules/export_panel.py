...
MODULE_TOKEN = "export_panel"


class ExportPanel(CodeEditorSubmodule):
    """CodeEditor submodule host control for `export_panel`."""

    control_type = "code_editor_export_panel"
