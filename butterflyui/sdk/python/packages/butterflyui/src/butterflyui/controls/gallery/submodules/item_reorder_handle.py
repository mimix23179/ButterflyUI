...
MODULE_TOKEN = "item_reorder_handle"


class ItemReorderHandle(GallerySubmodule):
    """Gallery submodule host control for `item_reorder_handle`."""

    control_type = "gallery_item_reorder_handle"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if from_index is not None:
            resolved_payload["from_index"] = from_index
        if id is not None:
        ...
        if to_index is not None:
            resolved_payload["to_index"] = to_index
        super().__init__(
            *children,
