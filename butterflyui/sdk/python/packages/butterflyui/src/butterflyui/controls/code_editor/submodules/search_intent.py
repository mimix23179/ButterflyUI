...
MODULE_TOKEN = "search_intent"


class SearchIntent(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_intent`."""

    control_type = "code_editor_search_intent"
