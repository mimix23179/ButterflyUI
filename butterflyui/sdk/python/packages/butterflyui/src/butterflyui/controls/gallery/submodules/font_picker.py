...
MODULE_TOKEN = "font_picker"


class FontPicker(GallerySubmodule):
    """Gallery submodule host control for `font_picker`."""

    control_type = "gallery_font_picker"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if selected_font is not None:
            resolved_payload["selected_font"] = selected_font
