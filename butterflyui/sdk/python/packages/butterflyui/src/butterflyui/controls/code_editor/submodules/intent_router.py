...
MODULE_TOKEN = "intent_router"


class IntentRouter(CodeEditorSubmodule):
    """CodeEditor submodule host control for `intent_router`."""

    control_type = "code_editor_intent_router"
