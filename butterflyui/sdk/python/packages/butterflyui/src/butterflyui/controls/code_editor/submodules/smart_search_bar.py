...
MODULE_TOKEN = "smart_search_bar"


class SmartSearchBar(CodeEditorSubmodule):
    """CodeEditor submodule host control for `smart_search_bar`."""

    control_type = "code_editor_smart_search_bar"
