...
MODULE_TOKEN = 'transform_toolbar'


class TransformToolbar(StudioSubmodule):
    """Studio submodule host control for `transform_toolbar`."""

    control_type = 'studio_transform_toolbar'
    umbrella = 'studio'
