...
class StatusBar(LayoutControl):
    ...
    """
    Foreground value forwarded to the `status_bar` runtime control.
    """

    text_color: Any | None = None
    """
    Text color value forwarded to the `status_bar` runtime control.
    """

    icon_color: Any | None = None
    """
    Icon color value forwarded to the `status_bar` runtime control.
    """

    icon_background: Any | None = None
    """
    Icon background value forwarded to the `status_bar` runtime control.
    """

    icon_foreground: Any | None = None
    """
    Icon foreground value forwarded to the `status_bar` runtime control.
    """

    icon_opacity: Any | None = None
    """
    Icon opacity value forwarded to the `status_bar` runtime control.
    """

    background: Any | None = None
    """
    Background value forwarded to the `status_bar` runtime control.
    """
    ...
    """
    Surface color value forwarded to the `status_bar` runtime control.
    """
    ...
    """
    Scrim color value forwarded to the `status_bar` runtime control.
    """
    ...
    """
    Leading icon value forwarded to the `status_bar` runtime control.
    """

    trailing_icon: Any | None = None
    """
    Trailing icon value forwarded to the `status_bar` runtime control.
    """

    icon_position: Any | None = None
    """
    Icon position value forwarded to the `status_bar` runtime control.
    """

    icon_size: Any | None = None
    """
    Icon size value forwarded to the `status_bar` runtime control.
    """

    icon_spacing: Any | None = None
    """
    Icon spacing value forwarded to the `status_bar` runtime control.
    """

    decorate_icon: Any | None = None
    """
    Decorate icon value forwarded to the `status_bar` runtime control.
    """

    transparency: Any | None = None
    """
    Transparency value forwarded to the `status_bar` runtime control.
    """

    alpha: Any | None = None
    """
    Alpha value forwarded to the `status_bar` runtime control.
    """

    auto_contrast: Any | None = None
    """
    Auto contrast value forwarded to the `status_bar` runtime control.
    """

    min_contrast: Any | None = None
    """
    Min contrast value forwarded to the `status_bar` runtime control.
    """
    ...
    """
    Clip behavior value forwarded to the `status_bar` runtime control.
    """
