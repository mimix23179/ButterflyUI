...
MODULE_TOKEN = "item_actions"


class ItemActions(GallerySubmodule):
    """Gallery submodule host control for `item_actions`."""

    control_type = "gallery_item_actions"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        *children: object,
        ...
        secondary_actions: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if primary_action is not None:
            resolved_payload["primary_action"] = primary_action
        ...
        if secondary_actions is not None:
            resolved_payload["secondary_actions"] = secondary_actions
