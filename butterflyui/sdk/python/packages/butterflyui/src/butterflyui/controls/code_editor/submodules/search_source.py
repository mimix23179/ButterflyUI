...
MODULE_TOKEN = "search_source"


class SearchSource(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_source`."""

    control_type = "code_editor_search_source"
