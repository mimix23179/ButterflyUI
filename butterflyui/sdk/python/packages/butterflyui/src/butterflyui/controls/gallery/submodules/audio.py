...
class Audio(GallerySubmodule):
    """Gallery submodule host control for `audio`."""

    control_type = "gallery_audio"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if channels is not None:
            resolved_payload["channels"] = channels
        ...
        if sample_rate is not None:
            resolved_payload["sample_rate"] = sample_rate
