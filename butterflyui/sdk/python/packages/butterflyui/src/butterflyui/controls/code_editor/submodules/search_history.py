...
MODULE_TOKEN = "search_history"


class SearchHistory(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_history`."""

    control_type = "code_editor_search_history"
