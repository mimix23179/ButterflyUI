...
MODULE_TOKEN = "inline_widget"


class InlineWidget(CodeEditorSubmodule):
    """CodeEditor submodule host control for `inline_widget`."""

    control_type = "code_editor_inline_widget"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if position is not None:
            resolved_payload["position"] = position
        ...
        if widget_id is not None:
            resolved_payload["widget_id"] = widget_id
