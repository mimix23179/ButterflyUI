...
MODULE_TOKEN = "video_renderer"


class VideoRenderer(GallerySubmodule):
    """Gallery submodule host control for `video_renderer`."""

    control_type = "gallery_video_renderer"
    umbrella = "gallery"
