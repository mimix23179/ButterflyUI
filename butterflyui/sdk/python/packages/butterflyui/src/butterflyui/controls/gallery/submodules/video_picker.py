...
MODULE_TOKEN = "video_picker"


class VideoPicker(GallerySubmodule):
    """Gallery submodule host control for `video_picker`."""

    control_type = "gallery_video_picker"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if selected_video is not None:
            resolved_payload["selected_video"] = selected_video
