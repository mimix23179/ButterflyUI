...
MODULE_TOKEN = "item_meta_row"


class ItemMetaRow(GallerySubmodule):
    """Gallery submodule host control for `item_meta_row`."""

    control_type = "gallery_item_meta_row"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if date_added is not None:
            resolved_payload["date_added"] = date_added
