...
MODULE_TOKEN = 'outline_editor'


class OutlineEditor(SkinsSubmodule):
    """Skins submodule host control for `outline_editor`."""

    control_type = 'skins_outline_editor'
    umbrella = 'skins'
