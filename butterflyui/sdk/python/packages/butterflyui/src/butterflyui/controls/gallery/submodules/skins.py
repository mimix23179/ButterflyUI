...
class Skins(GallerySubmodule):
    """Gallery submodule host control for `skins`."""

    control_type = "gallery_skins"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        *children: object,
        ...
        size: int | None = None,
        skin_groups: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if skin_groups is not None:
            resolved_payload["skin_groups"] = skin_groups
