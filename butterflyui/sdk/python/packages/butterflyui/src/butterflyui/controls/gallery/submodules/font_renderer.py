...
MODULE_TOKEN = "font_renderer"


class FontRenderer(GallerySubmodule):
    """Gallery submodule host control for `font_renderer`."""

    control_type = "gallery_font_renderer"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        *children: object,
        ...
        preview_size: int | float | None = None,
        ...
        **kwargs: object,
        ...
        if preview_size is not None:
            resolved_payload["preview_size"] = preview_size
