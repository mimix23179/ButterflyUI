...
MODULE_TOKEN = "item_selection_switch"


class ItemSelectionSwitch(GallerySubmodule):
    """Gallery submodule host control for `item_selection_switch`."""

    control_type = "gallery_item_selection_switch"
    umbrella = "gallery"
