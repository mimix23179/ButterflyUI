...
MODULE_TOKEN = 'canvas_surface'


class CanvasSurface(StudioSubmodule):
    """Studio submodule host control for `canvas_surface`."""

    control_type = 'studio_canvas_surface'
    umbrella = 'studio'
