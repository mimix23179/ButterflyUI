...
MODULE_TOKEN = "audio_renderer"


class AudioRenderer(GallerySubmodule):
    """Gallery submodule host control for `audio_renderer`."""

    control_type = "gallery_audio_renderer"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if playing is not None:
            resolved_payload["playing"] = playing
        if position_ms is not None:
            resolved_payload["position_ms"] = position_ms
