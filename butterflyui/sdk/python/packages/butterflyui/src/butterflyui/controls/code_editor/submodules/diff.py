...
class Diff(CodeEditorSubmodule):
    """CodeEditor submodule host control for `diff`."""

    control_type = "code_editor_diff"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if context_lines is not None:
            resolved_payload["context_lines"] = context_lines
        ...
        if inline is not None:
            resolved_payload["inline"] = inline
        if language is not None:
            resolved_payload["language"] = language
        if line_numbers is not None:
            resolved_payload["line_numbers"] = line_numbers
        if modified is not None:
            resolved_payload["modified"] = modified
        if original is not None:
            resolved_payload["original"] = original
