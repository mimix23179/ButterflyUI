...
MODULE_TOKEN = "item_tile"


class ItemTile(GallerySubmodule):
    """Gallery submodule host control for `item_tile`."""

    control_type = "gallery_item_tile"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if favorite is not None:
            resolved_payload["favorite"] = favorite
        ...
        if selected is not None:
            resolved_payload["selected"] = selected
