...
MODULE_TOKEN = "semantic_search"


class SemanticSearch(CodeEditorSubmodule):
    """CodeEditor submodule host control for `semantic_search`."""

    control_type = "code_editor_semantic_search"
