...
MODULE_TOKEN = 'stdin_injector'


class StdinInjector(TerminalSubmodule):
    """Terminal submodule host control for `stdin_injector`."""

    control_type = 'terminal_stdin_injector'
    umbrella = 'terminal'
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if submit_label is not None:
            resolved_payload['submit_label'] = submit_label
