...
MODULE_TOKEN = "workbench_editor"


class WorkbenchEditor(CodeEditorSubmodule):
    """CodeEditor submodule host control for `workbench_editor`."""

    control_type = "code_editor_workbench_editor"
