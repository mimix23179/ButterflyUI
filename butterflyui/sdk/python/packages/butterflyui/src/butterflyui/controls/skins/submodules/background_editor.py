...
MODULE_TOKEN = 'background_editor'


class BackgroundEditor(SkinsSubmodule):
    """Skins submodule host control for `background_editor`."""

    control_type = 'skins_background_editor'
    umbrella = 'skins'
    ...
    def __init__(
        ...
        *children: object,
        ...
        strict: bool = False,
        active_section: object | None = None,
        ...
        selection_ids: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if active_section is not None:
            resolved_payload['active_section'] = active_section
        ...
        if inspector is not None:
            resolved_payload['inspector'] = inspector
        ...
        if selection_ids is not None:
            resolved_payload['selection_ids'] = selection_ids
