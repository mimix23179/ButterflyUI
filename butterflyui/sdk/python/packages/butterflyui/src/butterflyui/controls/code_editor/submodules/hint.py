...
class Hint(CodeEditorSubmodule):
    """CodeEditor submodule host control for `hint`."""

    control_type = "code_editor_hint"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if active_hint is not None:
            resolved_payload["active_hint"] = active_hint
        if code is not None:
