...
MODULE_TOKEN = "item_badge"


class ItemBadge(GallerySubmodule):
    """Gallery submodule host control for `item_badge`."""

    control_type = "gallery_item_badge"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if priority is not None:
            resolved_payload["priority"] = priority
