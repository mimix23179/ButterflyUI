...
MODULE_TOKEN = "intent_search"


class IntentSearch(CodeEditorSubmodule):
    """CodeEditor submodule host control for `intent_search`."""

    control_type = "code_editor_intent_search"
