...
MODULE_TOKEN = 'shadow_editor'


class ShadowEditor(SkinsSubmodule):
    """Skins submodule host control for `shadow_editor`."""

    control_type = 'skins_shadow_editor'
    umbrella = 'skins'
