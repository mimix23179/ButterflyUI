...
MODULE_TOKEN = "document_picker"


class DocumentPicker(GallerySubmodule):
    """Gallery submodule host control for `document_picker`."""

    control_type = "gallery_document_picker"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if selected_document is not None:
            resolved_payload["selected_document"] = selected_document
