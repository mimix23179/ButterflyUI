...
class Center(CandySubmodule):
    """Candy submodule host control for `center`."""

    control_type = "candy_center"
    umbrella = "candy"
    ...
    def __init__(
        ...
        *children: object,
        ...
        strict: bool = False,
        height_factor: int | float | None = None,
        width_factor: int | float | None = None,
        **kwargs: object,
    ) -> None:
        resolved_payload = dict(payload or {})
        if height_factor is not None:
            resolved_payload["height_factor"] = height_factor
        if width_factor is not None:
            resolved_payload["width_factor"] = width_factor
        super().__init__(
            *children,
