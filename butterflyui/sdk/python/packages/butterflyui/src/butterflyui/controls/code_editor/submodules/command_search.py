...
MODULE_TOKEN = "command_search"


class CommandSearch(CodeEditorSubmodule):
    """CodeEditor submodule host control for `command_search`."""

    control_type = "code_editor_command_search"
