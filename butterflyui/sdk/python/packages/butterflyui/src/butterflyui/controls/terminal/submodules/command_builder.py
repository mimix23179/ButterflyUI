...
MODULE_TOKEN = 'command_builder'


class CommandBuilder(TerminalSubmodule):
    """Terminal submodule host control for `command_builder`."""

    control_type = 'terminal_command_builder'
    umbrella = 'terminal'
