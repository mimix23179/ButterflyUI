...
MODULE_TOKEN = "item_selectable"


class ItemSelectable(GallerySubmodule):
    """Gallery submodule host control for `item_selectable`."""

    control_type = "gallery_item_selectable"
    umbrella = "gallery"
