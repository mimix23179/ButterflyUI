...
MODULE_TOKEN = "inline_error_view"


class InlineErrorView(CodeEditorSubmodule):
    """CodeEditor submodule host control for `inline_error_view`."""

    control_type = "code_editor_inline_error_view"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if active_error is not None:
            resolved_payload["active_error"] = active_error
        if code is not None:
        ...
        if errors is not None:
            resolved_payload["errors"] = errors
