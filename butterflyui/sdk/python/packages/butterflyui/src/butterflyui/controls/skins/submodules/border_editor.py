...
MODULE_TOKEN = 'border_editor'


class BorderEditor(SkinsSubmodule):
    """Skins submodule host control for `border_editor`."""

    control_type = 'skins_border_editor'
    umbrella = 'skins'
