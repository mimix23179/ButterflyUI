...
MODULE_TOKEN = 'execution_lane'


class ExecutionLane(TerminalSubmodule):
    """Terminal submodule host control for `execution_lane`."""

    control_type = 'terminal_execution_lane'
    umbrella = 'terminal'
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if backend is not None:
            resolved_payload['backend'] = backend
        if border_width is not None:
            resolved_payload['border_width'] = border_width
        if bridge is not None:
            resolved_payload['bridge'] = bridge
        if capabilities is not None:
            resolved_payload['capabilities'] = capabilities
