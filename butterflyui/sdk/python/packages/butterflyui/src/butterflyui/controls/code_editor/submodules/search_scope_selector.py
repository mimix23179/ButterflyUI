...
MODULE_TOKEN = "search_scope_selector"


class SearchScopeSelector(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_scope_selector`."""

    control_type = "code_editor_search_scope_selector"
