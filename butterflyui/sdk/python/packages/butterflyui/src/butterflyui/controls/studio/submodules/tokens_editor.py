...
MODULE_TOKEN = 'tokens_editor'


class TokensEditor(StudioSubmodule):
    """Studio submodule host control for `tokens_editor`."""

    control_type = 'studio_tokens_editor'
    umbrella = 'studio'
