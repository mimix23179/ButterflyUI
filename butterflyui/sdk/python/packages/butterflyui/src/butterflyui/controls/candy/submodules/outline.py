...
MODULE_TOKEN = "outline"


class Outline(CandySubmodule):
    """Candy submodule host control for `outline`."""

    control_type = "candy_outline"
    umbrella = "candy"
    ...
    def __init__(
        ...
        *children: object,
        ...
        strict: bool = False,
        outline_color: str | int | None = None,
        outline_width: int | float | None = None,
        radius: int | float | None = None,
        **kwargs: object,
    ) -> None:
        resolved_payload = dict(payload or {})
        if outline_color is not None:
            resolved_payload["outline_color"] = outline_color
        if outline_width is not None:
            resolved_payload["outline_width"] = outline_width
