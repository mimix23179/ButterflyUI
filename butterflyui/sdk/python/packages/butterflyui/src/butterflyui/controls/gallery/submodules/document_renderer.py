...
MODULE_TOKEN = "document_renderer"


class DocumentRenderer(GallerySubmodule):
    """Gallery submodule host control for `document_renderer`."""

    control_type = "gallery_document_renderer"
    umbrella = "gallery"
