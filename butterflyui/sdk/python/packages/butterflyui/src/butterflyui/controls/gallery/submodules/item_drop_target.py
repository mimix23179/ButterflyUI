...
MODULE_TOKEN = "item_drop_target"


class ItemDropTarget(GallerySubmodule):
    """Gallery submodule host control for `item_drop_target`."""

    control_type = "gallery_item_drop_target"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if drop_group is not None:
            resolved_payload["drop_group"] = drop_group
