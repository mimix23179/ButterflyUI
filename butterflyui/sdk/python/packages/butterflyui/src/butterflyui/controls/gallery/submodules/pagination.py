...
MODULE_TOKEN = "pagination"


class Pagination(GallerySubmodule):
    """Gallery submodule host control for `pagination`."""

    control_type = "gallery_pagination"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if infinite_scroll is not None:
            resolved_payload["infinite_scroll"] = infinite_scroll
        if items is not None:
            resolved_payload["items"] = items
        if loading is not None:
            resolved_payload["loading"] = loading
        if page is not None:
            resolved_payload["page"] = page
        if page_size is not None:
            resolved_payload["page_size"] = page_size
