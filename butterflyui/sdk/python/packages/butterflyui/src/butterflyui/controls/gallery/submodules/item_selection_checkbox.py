...
MODULE_TOKEN = "item_selection_checkbox"


class ItemSelectionCheckbox(GallerySubmodule):
    """Gallery submodule host control for `item_selection_checkbox`."""

    control_type = "gallery_item_selection_checkbox"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if checked is not None:
            resolved_payload["checked"] = checked
