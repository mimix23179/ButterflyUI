...
MODULE_TOKEN = "search_results_view"


class SearchResultsView(CodeEditorSubmodule):
    """CodeEditor submodule host control for `search_results_view`."""

    control_type = "code_editor_search_results_view"
