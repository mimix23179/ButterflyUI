...
MODULE_TOKEN = "presets"


class Presets(GallerySubmodule):
    """Gallery submodule host control for `presets`."""

    control_type = "gallery_presets"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        *children: object,
        ...
        preset_groups: list[object] | None = None,
        ...
        **kwargs: object,
        ...
        if preset_groups is not None:
            resolved_payload["preset_groups"] = preset_groups
