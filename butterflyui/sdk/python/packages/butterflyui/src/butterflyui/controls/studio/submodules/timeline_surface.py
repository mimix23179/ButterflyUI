...
MODULE_TOKEN = 'timeline_surface'


class TimelineSurface(StudioSubmodule):
    """Studio submodule host control for `timeline_surface`."""

    control_type = 'studio_timeline_surface'
    umbrella = 'studio'
