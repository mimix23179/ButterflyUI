...
MODULE_TOKEN = "toolbar"


class Toolbar(GallerySubmodule):
    """Gallery submodule host control for `toolbar`."""

    control_type = "gallery_toolbar"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if import_enabled is not None:
            resolved_payload["import_enabled"] = import_enabled
        ...
        if upload_enabled is not None:
            resolved_payload["upload_enabled"] = upload_enabled
