...
MODULE_TOKEN = "aspect_ratio"


class AspectRatio(CandySubmodule):
    """Candy submodule host control for `aspect_ratio`."""

    control_type = "candy_aspect_ratio"
    umbrella = "candy"
