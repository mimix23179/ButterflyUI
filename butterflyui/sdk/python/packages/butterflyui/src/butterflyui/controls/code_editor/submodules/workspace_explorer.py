...
MODULE_TOKEN = "workspace_explorer"


class WorkspaceExplorer(CodeEditorSubmodule):
    """CodeEditor submodule host control for `workspace_explorer`."""

    control_type = "code_editor_workspace_explorer"
