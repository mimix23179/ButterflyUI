...
MODULE_TOKEN = "section_header"


class SectionHeader(GallerySubmodule):
    """Gallery submodule host control for `section_header`."""

    control_type = "gallery_section_header"
    umbrella = "gallery"
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if collapsible is not None:
            resolved_payload["collapsible"] = collapsible
        ...
        if section_id is not None:
            resolved_payload["section_id"] = section_id
        if section_index is not None:
            resolved_payload["section_index"] = section_index
