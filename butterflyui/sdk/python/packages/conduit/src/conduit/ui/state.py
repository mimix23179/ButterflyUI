...
class State(Generic[T]):
    """Minimal reactive state helper for Conduit components."""
    ...
    def bind(
        ...
        prop: str,
        *,
        session: ConduitSession | None = None,
...
def effect(state: State[T], handler: Callable[[T], Any], *, session: ConduitSession | None = None, immediate: bool = False) -> None:
