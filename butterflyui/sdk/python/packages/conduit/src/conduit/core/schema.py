...
class ConduitContractError(ValidationError):
    pass
...
def ensure_valid_props(control_type: str, props: Mapping[str, Any], *, strict: bool = False) -> None:
    ...
    if errors:
        raise ConduitContractError(errors)
...
def _merge_universal(schema: Mapping[str, Any]) -> dict[str, Any]:
    """Merge universal Conduit contracts into a control schema.
...
RUNTIME_PROP_HINTS = {
    ...
    'avatar_stack': ['items', 'max'],
    'badge': ['color', 'offset', 'radius', 'text', 'text_color'],
    'bar_plot': ['color', 'colors', 'max', 'min', 'spacing', 'values'],
    'blend_mode_picker': ['items'],
    ...
    'conduit_candy': ['allow_gif', 'images'],
    ...
    'conduit_webview': ['url', 'html', 'base_url', 'bgcolor', 'engine', 'webview_engine', 'fallback_engine', 'use_inapp', 'prevent_links', 'request_headers', 'headers', 'user_agent', 'javascript_enabled', 'js_enabled', 'dom_storage_enabled', 'third_party_cookies_enabled', 'cache_enabled', 'clear_cache_on_start', 'incognito', 'media_playback_requires_user_gesture', 'allows_inline_media_playback', 'allow_file_access', 'allow_universal_access_from_file_urls', 'allow_popups', 'open_external_links', 'init_timeout_ms'],
