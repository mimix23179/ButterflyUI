...
const Map<String, Object?> _baseTokens = {
  ...
  'borders': {'sm': 1, 'md': 1.5, 'lg': 2},
  'shadows': {'sm': 8, 'md': 18, 'lg': 30},
  'motion': {'fast_ms': 90, 'normal_ms': 180, 'slow_ms': 320},
  'depth': {'base': 0, 'overlay': 20, 'modal': 40},
  'overlay': {'scrim': '#78020617', 'focus_ring': '#A34F46E5'},
  'button': {
    'radius': 12,
    'padding': [10, 16],
  },
...
Widget _wrapComfyRoot(BuildContext context, StylingTokens tokens, Widget child) {
...
Widget Function(BuildContext, StylingTokens) _softGradientBackground(
  List<Color> colors,
) {
