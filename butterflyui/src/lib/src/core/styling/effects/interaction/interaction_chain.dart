...
import 'control_interaction_capabilities.dart';

Widget applyControlInteractionChain({
  ...
  final bundle = _InteractionBundle.fromList(
    modifiers,
    tokens: tokens,
...
class _InteractionBundle {
  ...
  _InteractionBundle restrictedTo(ControlInteractionCapabilities capabilities) {
  ...
  factory _InteractionBundle.fromList(
    List<Object?> raw, {
    required StylingTokens tokens,
    required Map<String, Object?> effectPresets,
  }) {
    ...
    Map<String, Object?> resolvePresetMap(Map<String, Object?> item) {
      ...
      return StylingTokens.mergeMaps(coerceObjectMap(preset), item);
    }
...
class _InteractionHost extends StatefulWidget {
  final String controlType;
  final String controlId;
  final _InteractionBundle bundle;
  ...
  @override
  State<_InteractionHost> createState() => _InteractionHostState();
}

class _InteractionHostState extends State<_InteractionHost>
  ...
  @override
  void didUpdateWidget(covariant _InteractionHost oldWidget) {
