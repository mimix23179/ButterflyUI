class ControlInteractionCapabilities {
  ...
  const ControlInteractionCapabilities({
  ...
  static ControlInteractionCapabilities forControl(String controlType) {
    ...
    return ControlInteractionCapabilities(
  ...
  static Map<String, Set<String>> _runtimeSlotMap =
      Map<String, Set<String>>.from(_defaultSlotMap);
