...
class ButterflyUIGradientSweep extends StatefulWidget {
  ...
  @override
  State<ButterflyUIGradientSweep> createState() =>
      _ButterflyUIGradientSweepState();
}

class _ButterflyUIGradientSweepState extends State<ButterflyUIGradientSweep>
...
class _ButterflyUIShimmerState extends State<ButterflyUIShimmer>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
...
class _ButterflyUIRippleBurstState extends State<ButterflyUIRippleBurst>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
  Offset? _center;
...
class ButterflyUIConfettiBurst extends StatefulWidget {
  ...
  @override
  State<ButterflyUIConfettiBurst> createState() =>
      _ButterflyUIConfettiBurstState();
}

class _ButterflyUIConfettiBurstState extends State<ButterflyUIConfettiBurst>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
  Offset? _center;
...
class ButterflyUINoiseDisplacement extends StatefulWidget {
  ...
  @override
  State<ButterflyUINoiseDisplacement> createState() =>
      _ButterflyUINoiseDisplacementState();
}

class _ButterflyUINoiseDisplacementState
    extends State<ButterflyUINoiseDisplacement>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
...
class ButterflyUIParallaxOffset extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
      offset: Offset(dx * depth, dy * depth),
      child: child,
    );
  }
}
...
class _ButterflyUILiquidMorphState extends State<ButterflyUILiquidMorph>
    with SingleTickerProviderStateMixin {
...
class ButterflyUIMorphingBorder extends StatefulWidget {
  ...
  @override
  State<ButterflyUIMorphingBorder> createState() =>
      _ButterflyUIMorphingBorderState();
}

class _ButterflyUIMorphingBorderState extends State<ButterflyUIMorphingBorder>
    with SingleTickerProviderStateMixin {
  AnimationController? _controller;
