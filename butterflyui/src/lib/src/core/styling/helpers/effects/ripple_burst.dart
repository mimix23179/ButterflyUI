...
Widget buildRippleBurstControl(
  ...
  final resolved = resolveStylingHelperProps(props, controlType: 'ripple_burst');
  return wrapWithEffectRenderLayers(
    controlId: controlId.isEmpty ? 'ripple_burst::layers' : '$controlId::layers',
    props: resolved,
    child: _RippleBurstControl(
      controlId: controlId,
      props: resolved,
