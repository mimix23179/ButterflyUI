...
Widget buildMotionControl(
  ...
  return _MotionControl(
    controlId: controlId,
    props: resolveStylingHelperProps(props, controlType: 'motion'),
...
class _MotionControlState extends State<_MotionControl>
  ...
  void didUpdateWidget(covariant _MotionControl oldWidget) {
    ...
    if (oldWidget.props != widget.props) {
      _state = resolveStylingHelperProps(widget.props, controlType: 'motion');
  ...
  Future<Object?> _handleInvoke(
    ...
    switch (method) {
      case 'set_props':
        setState(() {
          _state = resolveStylingHelperProps(
            {..._state, ...args},
            controlType: 'motion',
          );
          _configureEntryAnimation(start: false);
  ...
  Widget build(BuildContext context) {
    ...
    return wrapWithEffectRenderLayers(
      controlId: widget.controlId.isEmpty ? 'motion' : widget.controlId,
      props: _state,
      child: built,
    );
  }
