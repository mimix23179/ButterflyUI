...
Widget buildFoldLayerControl(
  ...
  final resolved = resolveStylingHelperProps(props, controlType: 'fold_layer');
  return wrapWithEffectRenderLayers(
    controlId: controlId.isEmpty ? 'fold_layer::layers' : '$controlId::layers',
    props: resolved,
    child: _FoldLayerControl(
    controlId: controlId,
    props: resolved,
