...
Widget buildBorderSideControl(
  ...
  final resolved = resolveStylingHelperProps(props, controlType: 'border_side');
  return wrapWithEffectRenderLayers(
    controlId: controlId.isEmpty ? 'border_side::layers' : '$controlId::layers',
    props: resolved,
    child: _BorderSideControl(
    controlId: controlId,
    props: resolved,
