...
Widget buildAvatarStackControl(
  ...
  final resolved = resolveStylingHelperProps(props, controlType: 'avatar_stack');
  return wrapWithEffectRenderLayers(
    controlId: controlId.isEmpty ? 'avatar_stack::layers' : '$controlId::layers',
    props: resolved,
    child: _AvatarStackControl(
    controlId: controlId,
    props: resolved,
    sendEvent: sendEvent,
