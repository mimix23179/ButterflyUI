...
class _BlobFieldControlState extends State<_BlobFieldControl> {
  ...
  void initState() {
    super.initState();
    _syncFromProps(_effectiveProps(widget.props));
  ...
  Widget build(BuildContext context) {
    ...
    return wrapWithEffectRenderLayers(
      controlId: widget.controlId.isEmpty ? 'blob_field' : widget.controlId,
      props: effective,
      child: CustomPaint(
  ...
  Map<String, Object?> _effectiveProps(Map<String, Object?> props) {
    return resolveStylingHelperProps(props, controlType: 'blob_field');
  }
}
