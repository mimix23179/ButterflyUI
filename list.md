...
- `gallery_search_bar` ✅
- `gallery_font_picker` ✅
- `gallery_audio_picker` ✅
- `gallery_video_picker` ✅
- `gallery_image_picker` ✅
- `gallery_item_drag_handle` ✅
- `gallery_item_drop_target` ✅
- `gallery_item_reorder_handle` ✅
- `gallery_item_selection_checkbox` ✅
- `gallery_item_selection_radio` ✅
- `gallery_item_selection_switch` ✅
- `gallery_apply` ✅
- `gallery_clear` ✅
- `gallery_select_all` ✅
